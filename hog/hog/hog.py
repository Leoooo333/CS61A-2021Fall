...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal :
        ...
        if turn == 0 :
            crus_say = say(score0, score1)
            turn += 1
        else:
            crus_say = crus_say(score0, score1)
        who = next_player(who)
    # END PROBLEM 5
    ...
    def say(score0, score1) :
        ...
        if who == 0 :
            if score0 - last_score > running_high :
                runninghigh = score0 - last_score
                print(f"{runninghigh} point(s)! That's a record gain for Player {who}!")
            lastscore = score0
        if who == 1 :
            if score1 - last_score > running_high :
                runninghigh = score1 - last_score
                print(f"{runninghigh} point(s)! That's a record gain for Player {who}!")
            lastscore = score1
